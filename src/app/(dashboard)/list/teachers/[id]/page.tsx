          ...
          <div className="bg-timoPurple py-6 px-4 rounded-md flex-1 flex gap-4">
            <div className="w-1/3">
              <Avatar className="w-24 h-24">
                <AvatarImage
                  src="https://images.pexels.com/photos/8790780/pexels-photo-8790780.jpeg?auto=compress&cs=tinysrgb&w=1200"
                  alt="avatar"
                />
              </Avatar>
            </div>
            <div className="w-2/3 flex flex-col justify-between gap-4">
              <h2 className="text-xl font-bold">Evelyn Howell</h2>
          ...
          <div className="flex flex-1 gap-4 justify-between flex-wrap">
            ...
            <div className="bg-white w-full flex p-4 rounded-md md:w-[48%] xl:w-[45%] 2xl:w-[48%] ">
              ...
              <div className="">
                ...
                <p className="text-sm font-medium text-gray-500">9</p>
              </div>
            </div>
          </div>
        </div>
